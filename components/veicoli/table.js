                            ...
                            <Link href={`${link}/${item.id}`} className="group flex items-center justify-between px-4 py-4 hover:bg-gray-50 sm:px-6">
                                <span className="flex items-center truncate space-x-3">
                                    <span
                                        ...
                                        aria-hidden="true"
                                    />
                                    <span className="font-medium truncate text-sm leading-6 uppercase">
                                        {item.modello} {' '} {item.targa}
                                    </span>
                                </span>
                                <ChevronRightIcon
                        ...
                        <thead>
                            <tr className="border-t border-gray-200">
                                <th className="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    <span className="lg:pl-2">Categoria patente</span>
                                </th>
                                <th className="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    <span className="lg:pl-2">Targa</span>
                                </th>
                                <th className="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    <span className="lg:pl-2">Workplace</span>
                                </th>
                                <th className="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    <span className="lg:pl-2">Modello</span>
                                </th>
                                    ...
                                    <td className="px-3 py-3 max-w-0 whitespace-nowrap text-sm font-medium text-gray-900">
                                        ...
                                        <div className="flex items-center space-x-3 ">
                                            <div
                                                ...
                                                aria-hidden="true"
                                            />
                                            <Link href={`${link}/${item.id}`} className=" hover:text-gray-600 break-normal">
                                                <span>
                                                    {item.Patenti.map((el, index) => (
                                                        <div key={el.patente.id}>
                                                            <span className="inline-flex items-center px-2.5 py-0.5 mr-3 mb-3 rounded-md text-sm font-medium bg-indigo-100 text-indigo-800 uppercase">
                                                                {el.patente.nome} <br />
                                                            </span>
                                                        </div>
                                                    ))}
                                    ...
                                    <td className="px-3 py-3 max-w-0 whitespace-nowrap text-sm font-medium text-gray-900">
                                        ...
                                        <div className="flex items-center space-x-3 ">
                                            <div
                                                ...
                                                aria-hidden="true"
                                            />
                                            <Link href={`${link}/${item.id}`} className="truncate hover:text-gray-600 uppercase">
                                                {item.targa}
                                            </Link>
                                        </div>
