...
export default function NewUser({
    ...
    const { data: rulesGroupList } = useSWR(isActive ? `/api/admin/rules/groups/list?isActive=${isActive.isActive}` : null, fetcher);

    const validateEmail = async (value) => {

        const checkFromat = await ValidateEmailFormat(value);
        if (!checkFromat) {
                                    ...
                                    <div className="flex items-start">
                                        <div className=" w-full">
                                            ...
                                            <div>
                                                ...
                                                >
                                                    <option value={null}>Seleziona un permesso...</option>
