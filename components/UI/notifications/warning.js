        ...
        <>
            ...
            >
                <div className="w-full flex flex-col items-center space-y-4 sm:items-end">
                    ...
                    <Transition
                        show={notifications.warning.show}
                        as={Fragment}
                            ...
                            <div className="p-4">
                                <div className="flex items-start">
                                    ...
                                    <div className="ml-3 w-0 flex-1 pt-0.5">
                                        <p className="text-sm font-medium text-gray-900">{notifications.warning.title ? notifications.warning.title : 'Salvataggio completato!'}</p>
                                        {notifications.warning.message !== false && <p className="mt-1 text-sm text-gray-500">{notifications.warning.message ? notifications.warning.message : "Continua a navigare!"}</p>}
                                    </div>
