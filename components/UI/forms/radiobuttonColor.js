...
export default function RadiobuttonColors({ selectedColor, setSelectedColor }) {
    ...
    return (
        <RadioGroup value={selectedColor} onChange={setSelectedColor}>
            <RadioGroup.Label className="block text-sm font-medium text-gray-700">Scegli un colore di riconoscimento</RadioGroup.Label>
