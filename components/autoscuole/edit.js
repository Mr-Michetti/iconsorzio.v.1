...
export default function EditAutoscuola({
    notify,
    id,
    autoscuola,
    setAutoscuola,
    ...
    const [onlyForRealod, setOnlyForReload] = useState();

    const alertDelete = async (id) => {
        notify.alert.setId({
            id: id
        });
        notify.alert.setTitle('Sei sicuro di voler disattivare questa autoscuola?');
        notify.alert.setMessage("Una volta disattivata potrà comunque essere riattivato nell'apposita sezione.")
    ...
    const alertReactivate = async (id) => {
        ...
        notify.alert2.setTitle('Sei sicuro di voler riattivare questa autoscuola?');
        notify.alert2.setMessage("Una volta riattivata l'autoscuola potrà essere comunque disattivata nuovamente.")
        notify.alert2.setShow(true);
    }
    // To deactivate autoscuola
    const deactivateAutoscuola = async () => {

        notify.loading.setShow(true);

        try {
            const res = await fetch('/api/autoscuole/delete', {
                method: 'POST',
    ...
    //To reactivated autoscuola
    const reactivateautoscuola = async () => {

        notify.loading.setShow(true);

        try {
            const res = await fetch('/api/autoscuole/reactivate', {
                method: 'POST',
                body: JSON.stringify({ id: id }),
                headers: {
                    'Content-Type': 'application/json'
    ...
    //PartIva Validation
    const validatePartIva = async (value) => {
        ...
        try {
            const res = await fetch('/api/autoscuole/checkAutoscuolaExist', {
                method: 'POST',
                body: JSON.stringify({ partIva: value, id: id }),
                headers: {
                    'Content-Type': 'application/json'
                },
            });
    ...
    return (
        <div className="space-y-8 divide-y divide-gray-200 p-8">
            <DeleteAlert clicked={deactivateAutoscuola} buttonName={'Disattiva'} />
            <ReactivateAlert clicked={reactivateautoscuola} buttonName={'Riattiva'} />
            <div className="space-y-8 divide-y divide-gray-200">
                <div>
                    <div>
                        <h3 className="text-lg leading-6 font-medium text-gray-900">Vedi/Modifica autoscuola</h3>
                        <p className="mt-1 text-sm text-gray-500">
                            In questa pagina stai modificando {autoscuola.denominazione}
                        </p>
                    </div>
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <div className="sm:col-span-6">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.denominazione}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, denominazione: e.target.value })}
                                    required
                                    type="text"
                                    name="denominazione"
                                    id="denominazione"
                                    ...
                                    <div className="relative flex items-start">
                                        <div className="flex items-center h-5">
                                            <input
                                                ...
                                                value={consorziato}
                                                checked={consorziato}
                                                onChange={() => setConsorziato(!consorziato)}
                        ...
                        <div className="sm:col-span-6">
                            ...
                            <div className="mt-1">
                                <input
                                    ...
                                    name="ragSoc"
                                    id="ragSoc"
                                    value={autoscuola.ragSoc}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, ragSoc: e.target.value })}
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-1">
                                <select
                                    value={autoscuola.provincia}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, provincia: e.target.value })}
                                    id="provincia"
                                    name="provincia"
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.comune}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, comune: e.target.value })}
                                    required
                                    type="text"
                                    name="comune"
                                    id="comune"
                        ...
                        <div className="sm:col-span-4">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.indirizzo}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, indirizzo: e.target.value })}
                                    required
                                    type="text"
                                    name="indirizzo"
                                    id="indirizzo"
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.nCiv}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, nCiv: e.target.value })}
                                    required
                                    type="text"
                                    name="nCiv"
                                    id="nCiv"
                ...
                <div className="pt-8">
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.partIva}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, partIva: e.target.value })}
                                    onBlur={(e) => validatePartIva(e.target.value)}
                                    maxLength="11"
                                    minLength="11"
                                    type="text"
                                    name="partIva"
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.codFisc}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, codFisc: e.target.value })}
                                    required
                                    type="text"
                                    name="codFisc"
                                    id="codFisc"
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.codMotorizzazione}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, codMotorizzazione: e.target.value })}
                                    required
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.sdi}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, sdi: e.target.value })}
                                    id="sdi"
                                    name="sdi"
                                    type="text"
                                    autoComplete="sdi"
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.pec}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, pec: e.target.value })}
                                    id="pec"
                                    name="pec"
                                    type="email"
                                    autoComplete="pec"
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.iban}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, iban: e.target.value })}
                                    id="iban"
                                    name="iban"
                                    type="text"
                                    autoComplete="iban"
                ...
                <div className="pt-8">
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        <div className="sm:col-span-6">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.email}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, email: e.target.value })}
                                    required
                                    id="email"
                                    name="email"
                                    type="email"
                                    autoComplete="email"
                                    className={`shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm ${validationFields.includes('email') ? 'border-red-500' : 'border-gray-300'} rounded-m"`}
                                />
                            </div>
                        </div>
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.tel1}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, tel1: e.target.value })}
                                    required
                                    id="tel1"
                                    name="tel1"
                                    type="text"
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.tel2}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, tel2: e.target.value })}
                                    id="tel2"
                                    name="tel2"
                                    type="text"
                                    autoComplete="tel2"
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.cel}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, cel: e.target.value })}
                                    id="cel"
                                    name="cel"
                                    type="text"
                                    autoComplete="cel"
                        ...
                        <div className="sm:col-span-3">
                            ...
                            <div className="mt-1">
                                <input
                                    value={autoscuola.fax}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, fax: e.target.value })}
                                    id="fax"
                                    name="fax"
                                    type="text"
                                    autoComplete="fax"
                        ...
                        <div className="sm:col-span-6">
                            ...
                            <div className="mt-1">
                                <textarea
                                    ...
                                    value={autoscuola.note}
                                    onChange={(e) => setAutoscuola({ ...autoscuola, note: e.target.value })}
                                />
                            </div>
            ...
            {autoscuola.isActive ?
                <div className="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                    <div className="md:grid md:grid-cols-3 md:gap-6">
                        <div className="md:col-span-1">
                            <h3 className="text-lg font-medium leading-6 text-gray-900">Disattivazione autoscuola</h3>
                            <p className="mt-1 text-sm text-gray-500">Sezione per disattivare l'autoscuola</p>
                        </div>
                        <div className="mt-5 md:mt-0 md:col-span-2">
                            <form className="space-y-6" action="#" method="POST">
                                <ButtonWithIconLeft clicked={() => alertDelete(id)} icon={ExclamationTriangleIcon} text={'Disattiva autoscuola'} color={'red'} />
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
                    <div className="md:grid md:grid-cols-3 md:gap-6">
                        <div className="md:col-span-1">
                            <h3 className="text-lg font-medium leading-6 text-gray-900">Riattivazione autoscuola</h3>
                            <p className="mt-1 text-sm text-gray-500">Sezione per riattivare l'autoscuola</p>
                        </div>
                        <div className="mt-5 md:mt-0 md:col-span-2">
                            <form className="space-y-6" action="#" method="POST">
                                <ButtonWithIconLeft clicked={() => alertReactivate(id)} icon={ExclamationTriangleIcon} text={'Riattiva autoscuola'} color={'green'} />
                            </form>
                        </div>
                    </div>
                </div>
